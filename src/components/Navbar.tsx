...
import { Menu, ShoppingBag, User2, X, Moon, Sun, ShieldCheck } from "lucide-react";
        ...
        <div className="fixed inset-0 z-[60] bg-background/95 backdrop-blur-2xl lg:hidden">
          <div className="container-page flex h-[72px] items-center justify-between">
            ...
            <button
              ...
              className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-border bg-surface/60"
            >
              <X className="h-4 w-4" />
            </button>
          </div>
